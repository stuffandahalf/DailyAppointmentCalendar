...
public class Appointment implements Comparable                                                  //class Appointment implements the Comparable interface
{
    ...
    {
        Appointment other2 = (Appointment) other;       //cast the Object other to a variable other2 of type Appointment
        return date.compareTo(other2.getDate());        //compare the dates of the two appointments and return the result
